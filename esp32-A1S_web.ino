...
/*
 * Settings ESP32-A1S v2.3  ESP32-LyraT
 * ESP32-A1S switch 2 & 3 ON
 *                  1  4  5  OFF
 * 
 * ESP32-LyraT jumper between 2 & 15
 * #define I2S_DSIN            26
 * #define I2S_BCLK             5
 * #define I2S_LRC             25
 * #define I2S_MCLK             0
...
<html>
  ...
  <body>
    ...
    <form action="/get">
    <p><small>
    <center><labelfor="dummy">ssid : </label><input type= "text" name="ssid"></center>
    <br>
    <center><labelfor="dummy">pswd : </label><input type= "text" name="pswd"></center>
    <br>
