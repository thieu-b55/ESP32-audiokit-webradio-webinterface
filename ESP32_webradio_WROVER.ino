 ...
 *  
 *  ESP32 EN   <<< pushbutton N.O. >>> GND    RESET 
 *  ESP32 EN   <<<      0.1uF      >>> GND
 *  ESP32 EN   <<<      R 10K      >>> +3.3V
 *  
 *  ESP32 I0.0 <<< pushbutton N.O  >>> GND    BOOT MODE 
 *  ESP32 I0.0 <<<      0.1uF      >>> GND
 *  ESP32 T0.0 <<<      R 10K      >>> +3.3V
 *  
 *  ESP32 WROVER programmeren :
 *  
 *  gebruik een FTDI FT232R USB UART zet op 3.3V
 *  verbind TX van FTDI met RX ESP32 GPIO3
 *  verbind RX van FTDI met TX ESP32 GPIO1
 *  GND van FTDI met GND ESP32
 *  
 *  Druk op RESET
 *  Druk op BOOT
 *  Los eerst de RESET knop en dan de BOOT knop
 *  ESP32 is nu in programmeer mode
 *  
 *  
 * PCM5102A 
 * FLT  >>  GND
